...
class DynamicOpsContinuousBatchingLayerCache:
    ...
    def _decode_update(
        ...
        source_mask_expanded = source_mask[:, None, :, None].expand(
        ...
        cache_target_mask_expanded = cache_target_mask[:, None, :, None].expand(
            batch_size, num_head, max_cache_len, head_dim
        )
